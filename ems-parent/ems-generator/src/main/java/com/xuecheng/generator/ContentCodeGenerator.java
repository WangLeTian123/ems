...
public class ContentCodeGenerator {
	...
	public static void main(String[] args) {
		...
		//生成路径
		gc.setOutputDir(System.getProperty("user.dir") + "/ems-parent/ems-generator/src/main/java");
		gc.setAuthor("letian");
		gc.setOpen(false);
		...
		dsc.setUrl("jdbc:mysql://localhost:3306/ems-" + SERVICE_NAME
